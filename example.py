...
bot = InstaBot(  # List of list of words, each of which will be used to generate comment
    ...
    log_mod=0,
    proxy='',
    comment_list=[['this', 'the', 'your'], ['photo', 'picture', 'pic',
                  'shot', 'snapshot'], ['is', 'looks', 'feels',
                  'is really'], [
        'great',
        'super',
        'good',
